...
const MlmUser = () => {
  const { allNewMlmUser, getNewMlmUser } = useContext(MyContext);
  ...
  console.log("allNewMlmUser ---->", allNewMlmUser);
                      ...
                      <TableRow key={row.id}>
                        ...
                        <TableCell>
                          <Button
                            variant="contained"
                            color="primary"
                            onClick={() => handleDetails(row?.user_Id)}
                          >
                            View Details
                          </Button>
                        </TableCell>
