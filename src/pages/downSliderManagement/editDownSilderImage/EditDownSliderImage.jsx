  ...
  return (
    <>
      <div id="edit" className="bg-gray-100 min-h-screen">
        {/* Header */}
        <MainHeader name={"Edit Down Slider"} />
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex items-center justify-between mt-6">
              ...
              <button
                ...
                onClick={() => navigate("/admin/Down-slider")}
              >
                Cancel
              </button>
            </div>
...
export default EditDownSliderImage;
